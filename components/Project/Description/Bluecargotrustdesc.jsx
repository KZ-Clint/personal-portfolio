...
export default function Bluecargotrustdesc () {
    ...
    <>
       <div className={styles.desc_gen_wrapper} >
           <p className={styles.desc_p} >
              Blue Cargo Trust is a logistics web application that lets you manage your logistics operations effectively.
              Blue Cargo Trust Incorporates various technologies to function ranging from storage, security and financials, My choice of Stack for this project took into consideration; SEO, Optimization, Responsiveness, Compatibility, Speed and Seamless Integration.
