...
export default function Unitedgrandtrustdesc () {
    ...
    <>
       <div className={styles.desc_gen_wrapper} >
           <p className={styles.desc_p} >
              United Grand Trust is a financial application that lets you use financial tools to facilitate your financial needs
              United Grand Trust Incorporates various technologies to function ranging from storage, security and financials, My choice of Stack for this project took into consideration; Optimization, Responsiveness, Compatibility, Speed and Seamless Integration.
