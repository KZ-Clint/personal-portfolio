...
import { upsApiTools, upsBackLibTools, upsFrontLibTools, upsStackTools } from '../Projecttools';
import Upsfastlogisticsdesc from './Description/Upsfastlogisticsdesc';



export default function Upsfastlogistics () {

  const [typedText, setTypedText] = useState('');
  const [typedPause, setTypedPause] = useState(false);
  const text = "UPPS Fast Logistics";
                ...
                <div className={styles.alleviate_links_wrapper} >
                    ...
                    <div className={styles.alleviate_live_link_wrapper} >
                        ...
                        <Link className={styles.live_link} target='_blank' href={`https://www.bluecargotrust.com`} >
                           https://www.upsfastlogistics.com
                        </Link>
                    </div>
                </div>
                <div className={styles.toolsgrid} >
                    <Stack stackTools={upsStackTools} />
                    <Apiintegration apiTools={upsApiTools} />
                    <Frontendlibrary frontLibTools={upsFrontLibTools} />
                    <Backendlibrary backLibTools={upsBackLibTools} />
                </div>   
                <Upsfastlogisticsdesc/>
            </div>
          </div>
      </div>
    </>
